...
#import multipop15 as mp #for direct computation of hazard functions in each time step, slower than multipop16 but doesn't rely on lookup table
import time
...
tau_sfa_exc = [0.1, 0.3, 1.] #time scales of kernel
tau_sfa_inh = [0.05]
J_sfa_exc = [0.,0.,0.]
J_sfa_inh = [0.]
...
figure(2, figsize=(2.5,2.5*1.),dpi=300)
clf()
